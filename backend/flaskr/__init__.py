...
def create_app(test_config=None):
    ...
    def new_question():
        ...
        try:
            ...
            save_question = Question(question=question, answer=answer, category=category, difficulty=difficulty)
    ...
    def search_questions():         
        ...
        try:
            ...
            format_questions = [question.format() for question in questions]#Makes the question a list
    ...
    def question_by_id(category_id):
        ...
        format_questions= [question.format() for question in questions]#Makes the questions a list
        paginate_questions=paginate(request, format_questions)
    ...
    def play():
        ...
        try:
            ...
            #Since category does not have a key of 0 we instead return all the questions
            if getCategoryId != 0:
                questions = Question.query.filter(Question.category==getCategoryId).all()
            else:
                questions = Question.query.all()
            ...
            #getting our questions by id and checking if our questions are present in the previous questions list
            for questionID in format_questions:
                if questionID['id'] not in prev_question:
